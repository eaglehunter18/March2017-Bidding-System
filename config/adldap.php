            ...
            */
            'connection_settings' => [
                ...
                */
                ...
                |
                */
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '172.22.1.70')),
                /*
                |--------------------------------------------------------------------------
                | Port
                |--------------------------------------------------------------------------
                ...
                */
                ...
                |
                */
                'base_dn' => env('ADLDAP_BASEDN', ' OU=Users , OU=Asal Staff ,DC=asaltech,DC=com'),
                /*
                |--------------------------------------------------------------------------
                ...
                */
                ...
                |
                */
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'AD'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Ldap@Asal'),
                /*
                |--------------------------------------------------------------------------
                | Follow Referrals
                |--------------------------------------------------------------------------
